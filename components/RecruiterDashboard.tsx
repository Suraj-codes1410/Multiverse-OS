...
export default function RecruiterDashboard({
  ...
  const roleRequirements = {
    backend: {
      ...
      description:
        'Focuses on building scalable API structures, robust secure filter chains, database ORM configurations, and type-safe systems.',
    },
    distributed: {
      ...
      description:
        'Focuses on asynchronous message brokers, inter-process binary communication protocol layers, and containerized deployments.',
    },
    ai: {
      ...
      description:
        'Focuses on embedding indexes, Vector DB query tuning, retrieval-augmented generation (RAG) pipelines, and timeseries geospatial forecasting.',
    },
  };
      ...
      <Container>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-xs text-text-secondary/80 font-mono">
                ...
                <span className="text-accent-cyan font-bold">90 SECONDS</span> •
                FOCUS: BACKEND SYSTEMS & AI ENGINE
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <Card hoverable={false} className="h-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono mb-4">
                ...
                <div className="bg-bg-primary/40 border border-border-subtle p-3 rounded-lg">
                  ...
                  <span className="text-text-primary font-bold">
                    {portfolio.education.currentYear} Student (Graduation{' '}
                    {portfolio.education.expectedGraduation})
                  </span>
                </div>
                <div className="bg-bg-primary/40 border border-border-subtle p-3 rounded-lg">
                  <span className="text-text-secondary block mb-0.5">
          ...
          <div>
            <Card
              hoverable={false}
              className="border-accent-cyan/20 h-full flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center gap-2 mb-4 border-b border-border-subtle/40 pb-2">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card
              hoverable={true}
              className="border-accent-cyan/20 flex flex-col justify-between"
            >
              <div>
                ...
                <h3 className="text-base font-bold text-text-primary mb-2 flex items-center gap-2">
                  <Server className="w-4.5 h-4.5 text-accent-cyan" /> Backend
                  Engineering
                </h3>
                <p className="text-xs text-text-secondary mb-4 leading-relaxed">
                  Design and implementation of highly structured, type-safe API
                  architectures, database mappings, and strict role-based route
                  security controls.
                </p>
              ...
              <div className="mt-4 pt-3 border-t border-border-subtle/30 text-[10px] font-mono">
                ...
                <span className="text-text-primary font-bold">
                  Decoupled microservice domains & secure REST/gRPC gateways.
                </span>
              </div>
            </Card>
            ...
            <Card
              hoverable={true}
              className="border-accent-purple/20 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3 border-b border-border-subtle/20 pb-2">
                  <span className="text-[10px] font-mono text-accent-purple tracking-wider uppercase font-semibold">
                    STRENGTH_02
                  </span>
                  <Badge
                    color="purple"
                ...
                <p className="text-xs text-text-secondary mb-4 leading-relaxed">
                  Configuring robust event-driven stream processing pipelines,
                  service-to-service RPC, concurrent sockets, and
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {projects
                        .filter((p) =>
                          ['patient-management-service', 'sahai'].includes(p.id)
                        )
                        .map((p) => (
                          <Link
                            key={p.id}
                            href={`/project/${p.id}`}
                            className="text-xs text-accent-purple hover:underline flex items-center gap-1 font-mono"
                          >
                            → [docket: {p.title}]
                          </Link>
                        ))}
              ...
              <div className="mt-4 pt-3 border-t border-border-subtle/30 text-[10px] font-mono">
                ...
                <span className="text-text-primary font-bold">
                  Low-latency service synchronization & event outbox pipelines.
                </span>
              </div>
            </Card>
            ...
            <Card
              hoverable={true}
              className="border-success-green/20 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3 border-b border-border-subtle/20 pb-2">
                  <span className="text-[10px] font-mono text-success-green tracking-wider uppercase font-semibold">
                    STRENGTH_03
                  </span>
                  <Badge
                    color="green"
                ...
                <h3 className="text-base font-bold text-text-primary mb-2 flex items-center gap-2">
                  <Cpu className="w-4.5 h-4.5 text-success-green" /> AI
                  Engineering
                </h3>
                <p className="text-xs text-text-secondary mb-4 leading-relaxed">
                  Integrating intelligent components: vector indexing for
                  semantic similarity checks, RAG pipelines, timeseries
                  forecasting models, and geospatial visual layers.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {projects
                        .filter((p) => ['sahai', 'orbitair'].includes(p.id))
                        .map((p) => (
                          <Link
                            key={p.id}
                            href={`/project/${p.id}`}
                            className="text-xs text-success-green hover:underline flex items-center gap-1 font-mono"
                          >
                            → [docket: {p.title}]
                          </Link>
                        ))}
              ...
              <div className="mt-4 pt-3 border-t border-border-subtle/30 text-[10px] font-mono">
                ...
                <span className="text-text-primary font-bold">
                  98% environmental forecast accuracy & sub-second wellness RAG.
                </span>
              </div>
            </Card>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-border-subtle/50 bg-bg-panel/40 p-4 rounded-xl relative overflow-hidden">
                  ...
                  <p className="text-xs text-text-secondary mb-3 leading-relaxed">
                    Developed <strong>ORBITAIR</strong>, an AI-powered
                    geospatial AQI forecasting system. Competed against 823
                    teams nationwide. Designed high-volume time-series
                    geospatial query structures and hypertable partitioning.
                  </p>
                  <div className="flex items-center justify-between pt-2.5 border-t border-border-subtle/20 text-xs">
                    <span className="font-mono text-text-secondary">
                      PROJECT_LINK:{' '}
                      <Link
                        href="/project/orbitair"
                ...
                <div className="border border-border-subtle/50 bg-bg-panel/40 p-4 rounded-xl relative overflow-hidden">
                  ...
                  <p className="text-xs text-text-secondary mb-3 leading-relaxed">
                    Selected to represent ADGIPS at the SIH National Finals for
                    building <strong>SAHAI</strong>, a mental health & lifestyle
                    platform. Integrated a Pinecone-backed retrieval-augmented
                    generation (RAG) wellness assistant and managed concurrent
                    therapist chat rooms via WebSockets.
                  </p>
                  <div className="flex items-center justify-between pt-2.5 border-t border-border-subtle/20 text-xs">
                    <span className="font-mono text-text-secondary">
                      PROJECT_LINK:{' '}
                      <Link
                        href="/project/sahai"
                        className="text-warning-amber hover:underline"
                      >
                        SAHAI Dossier
                      </Link>
                    </span>
                    <span className="font-mono text-accent-purple font-bold">
                      RAG_ASSISTANT & WEBSOCKETS
                    </span>
                  </div>
                </div>
                ...
                <div className="border border-border-subtle/50 bg-bg-panel/40 p-4 rounded-xl relative overflow-hidden">
                  ...
                  <p className="text-xs text-text-secondary mb-3 leading-relaxed">
                    Placed in the top 5 and awarded the Civic Prize for
                    developing civic tech solutions resolving local municipal
                    challenges. Engineered workflow routing protocols for
                    immediate community reporting of infrastructure failures.
                  </p>
                  <div className="flex items-center justify-between pt-2.5 border-t border-border-subtle/20 text-xs">
                    <span className="font-mono text-text-secondary">
                      OUTCOME:{' '}
                      <span className="text-text-primary">
                        Civic Tech Deployment Strategy
                      </span>
                    </span>
            ...
            <Card hoverable={false}>
              ...
              <div className="space-y-4">
                <p className="text-xs text-text-secondary leading-relaxed mb-2">
                  System performance and project recognition metrics extracted
                  dynamically from portfolio data models:
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {projects
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="bg-bg-primary/30 border border-border-subtle/70 p-3 rounded-lg flex gap-3"
                      >
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <span className="text-[9px] font-mono uppercase text-accent-purple font-semibold">
                              [{item.projectTitle}]
                            </span>
            ...
            <Card hoverable={false}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {featuredProjects.map((project) => (
                  <div
                    key={project.id}
                    className="border border-border-subtle bg-bg-primary/20 p-5 rounded-xl flex flex-col justify-between hover:border-border-bright transition-all duration-300"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[9px] font-mono text-accent-purple uppercase tracking-wider">
                          {project.subtitle}
                        </span>
                        <Badge
                          color="purple"
          ...
          <div className="space-y-6">
            ...
            <Card hoverable={false}>
              <h3 className="text-xs font-mono uppercase tracking-widest text-text-primary mb-4 border-b border-border-subtle/40 pb-2 flex items-center gap-2">
                <Database className="w-4 h-4 text-accent-cyan" /> Technology
                Coverage
              </h3>
                    ...
                    <div key={tech.name} className="space-y-1">
                      <div className="flex justify-between text-xs font-mono">
                        ...
                        <span className="text-text-secondary font-semibold">
                          {tech.count} {tech.count === 1 ? 'docket' : 'dockets'}{' '}
                          ({tech.percentage}%)
                        </span>
                      </div>
            ...
            <Card hoverable={false}>
              <h3 className="text-xs font-mono uppercase tracking-widest text-warning-amber mb-4 border-b border-border-subtle/40 pb-2 flex items-center gap-2">
                <Trophy className="w-4 h-4 text-warning-amber" /> Achievements
                Summary
              </h3>
              ...
              <div className="space-y-3">
                {achievements.map((ach, i) => (
                  <div
                    key={i}
                    className="border-l-2 border-warning-amber/30 pl-3 py-0.5"
                  >
            ...
            <Card
              hoverable={false}
              className="border-border-bright/20 bg-bg-panel/85"
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-1">
                    {(
                      Object.keys(roleRequirements) as Array<
                        keyof typeof roleRequirements
                      >
                    ).map((role) => (
                      <button
                        key={role}
                ...
                <div className="bg-bg-primary/50 border border-border-subtle p-3 rounded-lg text-xs space-y-2">
                  <div className="flex justify-between items-center border-b border-border-subtle/30 pb-1.5">
                    <span className="font-bold text-text-primary">
                      {roleRequirements[selectedRole].title}
                    </span>
                    <Badge color="green" variant="solid" className="text-[8px]">
                      100% VERIFIED
                    </Badge>
                  </div>
                  ...
                  {/* Skills Checklist */}
                  <div className="space-y-1">
                    <span className="text-[9px] font-mono text-text-secondary block uppercase">
                      Verified Skill Checks:
                    </span>
                    <div className="grid grid-cols-2 gap-1 font-mono text-[9px]">
                      {roleRequirements[selectedRole].skills.map(
                        (skillName) => {
                ...
                <div className="space-y-2 pt-2 border-t border-border-subtle/30">
                  ...
                  {showJdResult && (
                    <div className="p-2.5 bg-accent-cyan/5 border border-accent-cyan/20 rounded font-mono text-[10px] text-text-secondary leading-relaxed space-y-1.5">
                      ...
                      <p>
                        AI parser model pipeline is offline (strictly zero
                        external API calls/generated scores).
                      </p>
                      <p>
                        <strong>Extension Config:</strong> Embeddings endpoint
                        ready in <code>next.config.ts</code> for Phase 4 neural
                        matching against portfolio embeddings vector store.
                      </p>
                    </div>
                  )}
                </div>
