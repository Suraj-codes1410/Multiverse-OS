...
export default function MissionBriefing({
  ...
  const statusColor =
    ...
    project.status.toLowerCase() === 'synced'
      ? 'green'
      : 'amber';
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card
              hoverable={false}
              className="border-border-subtle bg-bg-panel/30"
            >
              ...
              <div className="space-y-4 font-sans text-sm">
                <div>
                  <h3 className="text-xs font-mono text-accent-cyan uppercase mb-1.5 select-none">
                    &gt; Mission Objective
                  </h3>
                ...
                <div>
                  <h3 className="text-xs font-mono text-accent-purple uppercase mb-1.5 select-none">
                    &gt; Problem Statement
                  </h3>
            ...
            >
              ...
              <div className="space-y-4 font-sans text-sm">
                <div>
                  <h3 className="text-xs font-mono text-success-green uppercase mb-1.5 select-none">
                ...
                <div>
                  <h3 className="text-xs font-mono text-text-primary/70 uppercase mb-1.5 font-bold select-none">
            ...
            >
              ...
              <div className="font-sans text-sm leading-relaxed">
                {project.challenges && project.challenges.length > 0 ? (
                  ...
                  <p className="text-text-secondary italic font-mono text-xs select-none">
                    No anomalies or operational blockages registered.
                  </p>
                )}
              </div>
            </Card>
              ...
              <div className="space-y-4 font-sans text-sm">
                ...
                <div>
                  ...
                  {project.lessons && project.lessons.length > 0 ? (
                    ...
                    <p className="text-text-secondary italic font-mono text-xs select-none">
                      No post-mortem analysis records found.
                    </p>
                  )}
                </div>
              </div>
            ...
            {project.githubRepository && (
              ...
              >
                <div className="flex items-center justify-between mb-4 border-b border-border-subtle/50 pb-2 select-none">
                  ...
                  <Link
                    href={`/github/${project.githubRepository.name}`}
                    className="text-xs font-mono text-accent-cyan hover:underline flex items-center gap-0.5"
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-mono">
                    ...
                    <div className="bg-bg-primary/40 border border-border-subtle p-3 rounded-lg">
                      ...
                      <span className="text-text-primary font-bold">
                        {project.githubRepository.starsCount} ★ /{' '}
                        {project.githubRepository.forksCount} ⑂
                      </span>
                    </div>
                    <div className="bg-bg-primary/40 border border-border-subtle p-3 rounded-lg">
                      <span className="text-text-secondary block mb-0.5">
                      ...
                      <span className="text-success-green font-bold uppercase">
                        {project.intelligence?.activityLevel || 'STABLE'}
                      </span>
                    </div>
                  </div>
                  ...
                  {project.intelligence && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-bg-primary/25 border border-border-subtle/60 p-4 rounded-lg text-xs leading-normal">
                        <span className="text-accent-cyan font-mono text-[10px] block uppercase mb-2 font-bold">
                          &gt; Core Concepts
                        </span>
                        <ul className="space-y-1">
                          {project.intelligence.keyConcepts.map(
                            (concept, idx) => (
                              <li
                                key={idx}
                                className="flex items-center gap-1.5 text-text-secondary"
                              >
                                <Sparkles className="w-3 h-3 text-accent-cyan flex-shrink-0" />{' '}
                                {concept}
                              </li>
                            )
                          )}
                      ...
                      {/* Complexity */}
                      <div className="bg-bg-primary/25 border border-border-subtle/60 p-4 rounded-lg text-xs leading-normal">
                        <span className="text-accent-purple font-mono text-[10px] block uppercase mb-2 font-bold">
                          &gt; Complexity Indicators
                        </span>
                        <ul className="space-y-1">
                          {project.intelligence.complexityIndicators.map(
                            (indicator, idx) => (
                              <li
                                key={idx}
                                className="flex items-center gap-1.5 text-text-secondary"
                              >
                                <Activity className="w-3.5 h-3.5 text-accent-purple flex-shrink-0" />{' '}
                                {indicator}
                              </li>
                            )
                          )}
                  ...
                  {project.readme && (
                    <div>
                      <h3 className="text-xs font-mono text-text-secondary uppercase mb-2 select-none">
          ...
          <div className="space-y-6 select-none">
            ...
            <Card
              hoverable={false}
              className="border-border-subtle bg-bg-panel/20 p-5"
            >
            ...
            <Card
              hoverable={false}
              className="border-dashed border-border-subtle bg-[#0a0d16]/30 p-5 opacity-60"
            >
              ...
              <p className="text-[10px] text-text-secondary/70 leading-relaxed font-sans font-light">
                Secure integration path for ORACLE system analytics. Connects
                real-time compiler telemetry and AI metrics evaluation on this
                build.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-[10px] text-text-secondary/70 leading-relaxed font-sans font-light">
                Milestone tracking datastream for operational deployments. Maps
                historical project milestones, commit frequency, and release
                paths.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-[10px] text-text-secondary/70 leading-relaxed font-sans font-light">
                Candidate alignment report panel. Matches project challenges and
                achievements against targeted job skills matrices.
              </p>
            </Card>
          </div>
        </div>
