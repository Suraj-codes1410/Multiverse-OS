...
export function RobotLayer() {
  ...
  const [companionStatus, setCompanionStatus] = useState<
    'idle' | 'scanning' | 'thinking' | 'excited'
  >('scanning');
      ...
      setScanNodes([
        {
          ...
          width: 220,
          height: 40,
          label: 'INDEXING: branding_identity',
        },
        {
          ...
          width: 320,
          height: 75,
          label: 'SCANNING: telemetry_clock_widget',
        },
        {
          x: window.innerWidth - 340,
          y: 170,
          width: 320,
          height: 75,
          label: 'MONITORING: node_cpu_stats_widget',
        },
        {
          ...
          width: 380,
          height: 70,
          label: 'VALIDATING: app_shortcuts_dock',
        },
      ]);
    };
    ...
    >
      ...
      <div className="absolute bottom-20 right-6 pointer-events-auto bg-bg-panel/90 border border-window-border backdrop-blur-md pl-3 pr-4 py-2.5 rounded-2xl flex items-center gap-3 select-none font-sans text-[10px] text-text-secondary shadow-lg z-[200]">
        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              className="w-5.5 h-5.5 transform hover:scale-110 transition-transform"
            >
              {/* Ears / Antennas */}
              <path
              ...
              <circle
                ...
                cy="5.5"
                r="1"
                fill={companionStatus === 'excited' ? '#27c93f' : '#E06A3F'}
              />
              <circle
                cx="20"
                cy="5.5"
        ...
        <div className="flex flex-col select-none leading-none">
          <span className="text-[8px] font-mono text-text-secondary/70 uppercase tracking-wider">
            Telemetry Companion
          </span>
        ...
        >
          <RefreshCw
            className={`w-3 h-3 ${isScanning ? 'animate-spin-slow' : 'opacity-50'}`}
          />
        </button>
      </div>
    </div>
