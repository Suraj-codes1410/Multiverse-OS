    ...
    <div className="flex-grow overflow-y-auto px-4 py-8 font-sans select-text scrollbar-thin">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xs sm:text-sm font-mono text-accent-cyan tracking-widest mb-6">
          BACKEND DEVELOPER <span className="text-text-secondary/35">|</span> AI
          ENGINEER <span className="text-text-secondary/35">|</span> SYSTEMS
          ARCHITECT
        </p>

        {/* Value Proposition */}
        <h2 className="text-base sm:text-lg text-text-secondary max-w-xl mx-auto leading-relaxed mb-8 font-light">
          Architecting high-performance distributed systems, low-latency
          concurrent APIs, and intelligent multi-agent prompting pipelines.
        </h2>
