...
export async function buildKnowledgeGraph(
    ...
    graph.addNode({
      ...
      properties: {
        ...
        architecturePattern:
          ...
          'Monolith',
        complexityRating:
          project.intelligence?.complexityAnalysis?.overallRating || 'Beginner',
        complexityScore:
          project.intelligence?.complexityAnalysis?.totalScore || 0,
      ...
      skill.relatedProjects.forEach((projId) => {
        ...
        if (graph.getNode(projectId)) {
          graph.addRelationship({
            ...
            type: 'BUILT_WITH',
            properties: {
              description: `Project is built with skill: ${skill.name}`,
            },
          });
          graph.addRelationship({
            sourceId: skillId,
      ...
      project.techStack.forEach((tech) => {
        ...
        if (graph.getNode(skillId)) {
          ...
          graph.addRelationship({
            ...
            type: 'USES',
            properties: {
              description: `Technology is used in: ${project.title}`,
            },
          });
        }
      });
      ...
      Object.entries(profile.categories).forEach(([category, techs]) => {
        techs.forEach((tech) => {
          ...
          if (!graph.getNode(skillId)) {
            ...
            else if (category === 'Messaging' || category === 'RPC')
      ...
      skill.relatedTechnologies.forEach((techName) => {
        ...
        if (graph.getNode(targetSkillId)) {
          graph.addRelationship({
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Technology relation: ${skill.name} is related to ${techName}`,
            },
          });
          graph.addRelationship({
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Technology relation: ${techName} is related to ${skill.name}`,
            },
          });
        }
      });
  ...
  projects.forEach((project) => {
    ...
    if (graph.getNode(repoId)) {
      graph.addRelationship({
        ...
        type: 'RELATED_TO',
        properties: {
          description: `Project links to code repository: ${repoName}`,
        },
      });
      graph.addRelationship({
        sourceId: projectId,
        ...
        type: 'DEPENDS_ON',
        properties: {
          description: `Project code resides in repository: ${repoName}`,
        },
      });
      graph.addRelationship({
        sourceId: repoId,
        ...
        type: 'RELATED_TO',
        properties: {
          description: `Repository contains source code for project: ${project.title}`,
        },
      });
      ...
      achievements.forEach((ach) => {
        ...
        const titleMatches =
          ach.title.toLowerCase().includes(project.title.toLowerCase()) ||
          ach.title.toLowerCase().includes(project.id.toLowerCase());
        const descMatches =
          ach.description.toLowerCase().includes(project.title.toLowerCase()) ||
        ...
        if (titleMatches || descMatches) {
          graph.addRelationship({
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Repository contains source code for achievement: ${ach.title}`,
            },
          });
          graph.addRelationship({
            sourceId: achId,
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Achievement references code repository: ${repoName}`,
            },
          });
        }
      });
      ...
      exp.technologies.forEach((tech) => {
        ...
        if (graph.getNode(skillId)) {
          ...
          graph.addRelationship({
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Technology is utilized in professional role: ${exp.role} at ${exp.company}`,
            },
          });
        }
      });
  ...
  achievements.forEach((ach) => {
    ...
    projects.forEach((project) => {
      ...
      if (titleMatches || descMatches) {
        graph.addRelationship({
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Project is associated with achievement: ${ach.title}`,
          },
        });
        graph.addRelationship({
          sourceId: achId,
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Achievement was earned in project: ${project.title}`,
          },
        });
          ...
          project.techStack.forEach((tech) => {
            ...
            if (graph.getNode(skillId)) {
              graph.addRelationship({
                ...
                type: 'RELATED_TO',
                properties: {
                  description: `Achievement involved technology via project context: ${tech}`,
                },
              });
              graph.addRelationship({
                sourceId: skillId,
                ...
                type: 'RELATED_TO',
                properties: {
                  description: `Technology is referenced in achievement via project: ${ach.title}`,
                },
              });
            }
          });
          ...
          project.intelligence.technologies.forEach((tech) => {
            ...
            if (graph.getNode(skillId)) {
              graph.addRelationship({
                ...
                type: 'RELATED_TO',
                properties: {
                  description: `Achievement involved technology via project repository intelligence: ${tech}`,
                },
              });
              graph.addRelationship({
                sourceId: skillId,
                ...
                type: 'RELATED_TO',
                properties: {
                  description: `Technology is referenced in achievement via repo intelligence: ${ach.title}`,
                },
              });
            }
          });
    ...
    skills.forEach((skill) => {
      ...
      const skillMentioned =
        ach.title.toLowerCase().includes(skill.name.toLowerCase()) ||
      ...
      if (skillMentioned) {
        graph.addRelationship({
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Achievement text references technology: ${skill.name}`,
          },
        });
        graph.addRelationship({
          sourceId: skillId,
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Technology is associated with achievement: ${ach.title}`,
          },
        });
      }
    });
    ...
    timeline.forEach((event) => {
      ...
      if (isMatch) {
        graph.addRelationship({
          ...
          type: 'ACHIEVED_AT',
          properties: {
            description: `Achievement was recognized at timeline milestone: ${event.title}`,
          },
        });
      }
    });
  ...
  timeline.forEach((event) => {
    ...
    projects.forEach((project) => {
      const projectId = makeId('project', project.id);
      const isRelated =
        event.title.toLowerCase().includes(project.title.toLowerCase()) ||
      ...
      if (isRelated) {
        graph.addRelationship({
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Timeline milestone corresponds to project: ${project.title}`,
          },
        });
      }
    });
      ...
      achievements.forEach((ach) => {
        ...
        if (isHackathonAch) {
          graph.addRelationship({
            ...
            type: 'RELATED_TO',
            properties: {
              description: `Hackathon participation yielded: ${ach.title}`,
            },
          });
          graph.addRelationship({
            sourceId: achId,
            ...
            properties: {
              description: `Achievement gained through hackathon: ${event.title}`,
            },
          });
        }
      });
    ...
    if (event.type === 'education' && portfolio.education) {
      ...
      if (graph.getNode(eduId)) {
        graph.addRelationship({
          ...
          type: 'RELATED_TO',
          properties: {
            description: `Education timeline event linked to academic program`,
          },
        });
      }
    }
  ...
  repoNodes.forEach((node) => {
    ...
    if (repo) {
      ...
      if (intel?.architectureAnalysis) {
        node.properties.architecturePattern =
          intel.architectureAnalysis.architecturePattern;
        node.properties.communication =
          intel.architectureAnalysis.communication;
      ...
      if (intel?.complexityAnalysis) {
        node.properties.complexityRating =
          intel.complexityAnalysis.overallRating;
