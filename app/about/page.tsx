...
export const metadata = {
  ...
  description:
    "Learn about Suraj Samanta's journey, technical focus, learning targets, and professional career history.",
};
    ...
    <div className="flex-grow py-8">
      <Container>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card hoverable={false} className="h-full">
              ...
              <div className="space-y-4 text-sm md:text-base text-text-secondary leading-relaxed font-light">
                <p>
                  I am a Backend Developer and AI Engineer who thrives on
                  solving difficult computational and architectural problems. My
                  professional path is driven by a deep curiosity about how
                  large-scale computer systems manage and move data, and how we
                  can use artificial intelligence to solve complex workflows
                  autonomously.
                </p>
                <p>
                  I enjoy working at the boundary where systems software meets
                  machine learning. I believe that writing good code is about
                  more than just solving the immediate bug—it is about designing
                  clean interfaces, understanding performance limits (CPU cache
                  misses, garbage collection, serialization), and keeping
                  systems maintainable for years to come.
                </p>
                <p>
                  Whether it is optimizing a custom HNSW vector database in
                  Rust, managing state transitions in a multi-agent AI system,
                  or debugging a Kafka backpressure queue, I focus on
                  engineering solid, reproducible solutions.
                </p>
              </div>
            </Card>
          </div>
            ...
            <Card hoverable={false} className="p-5">
              ...
              <div className="space-y-2 text-xs text-text-secondary">
                ...
                <div className="flex justify-between font-mono text-[10px]">
                  <span>TIMELINE:</span>
                  <span>
                    {portfolio.education.currentYear} (Exp:{' '}
        ...
        <div className="mb-16">
          <Card
            hoverable={false}
            className="bg-bg-panel/40 border-accent-cyan/10"
          >
